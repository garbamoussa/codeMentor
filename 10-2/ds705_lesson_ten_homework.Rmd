...
```{r}
newdata = data.frame(Tonnage=10,000)
...
The 95% prediction interval of the Time  for the Tonnage time of 10,000 is between -10.12732 and 34.94709.
...
```{r}
#glakes_mod2 <- lm(log_Time ~ Tonnage_fourth_root, data = glakes)
newdata = data.frame(Tonnage_fourth_root=10,000^(1/4))
